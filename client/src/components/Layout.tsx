...
import { Menu, Phone, Mail, LogIn, LogOut, Facebook, Instagram, Twitter, Youtube, Linkedin } from "lucide-react";
              ...
              <div className="flex flex-col gap-8 mt-8">
                ...
                <nav className="flex flex-col gap-4">
                  ...
                  {isAuthenticated ? (
                    ...
                    >
                      {t("nav.logout")} ({user?.name || user?.role})
                    </Button>
                  ) : (
                    <Link href="/login">
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-sidebar-foreground/80">
              ...
              <li><Link href="/pujaris"><a className="hover:text-primary">{t("nav.pujaris")}</a></Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-sidebar-foreground/80">
              <li className="flex items-center gap-2"><Phone size={14} /> +91 90146 54994</li>
              <li className="flex items-center gap-2"><Mail size={14} /> support@bseva.com</li>
            </ul>
          </div>
          <div>
            <h4 className="font-heading font-bold text-lg mb-4 text-primary">{t("footer.demoAccess")}</h4>
            <p className="text-sm text-sidebar-foreground/70 mb-3">
              customer@bseva.com · pujari@bseva.com · admin@bseva.com (password123)
            </p>
            <Link href="/login">
