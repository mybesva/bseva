-- Phase 3: preferred language UX support, joining fee, cost components, muhurta, recommendations, astrology categories, accept/reject, penalties, distance assign
-- Applied automatically via backend schema_migrate / phase3_migrate on app startup.
-- This file documents the same changes for Supabase CLI / ops review.
