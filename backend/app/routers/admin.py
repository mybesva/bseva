...
def create_service(body: ServiceIn, user=Depends(require_permission("manage_services")), db: Session = Depends(get_db)):
    ...
    db.execute(
        ...
        ),
        {
            ...
            "pujn_basic": body.basic_pujaris_required,
            "pujn_std": body.standard_pujaris_required,
            "pujn_prm": body.premium_pujaris_required,
    ...
    result = db.execute(
        text(
            ...
            UPDATE services SET name=:name, slug=:slug, description=:desc,
              ...
              premium_pujaris_required=:pujn_prm,
