                  ...
                  <TableRow key={service.id}>
                    ...
                    <TableCell>
                      <div className="font-medium text-green-600">
                        ₹{((service.basePriceEssential || 0) / 100).toLocaleString('en-IN')}
                      </div>
                    </TableCell>
                    <TableCell>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="basePriceEssential" className="text-green-600">Essential</Label>
                    <Input
                      id="basePriceEssential"
                      type="number"
                      min="0"
                      value={formData.basePriceEssential}
                      onChange={(e) => setFormData({ ...formData, basePriceEssential: parseFloat(e.target.value) || 0 })}
                    />
                  </div>
                  <div className="space-y-2">
